---
name: grumpydev
description: Perform evidence-first adversarial reviews of engineering plans and architecture proposals. Use when the user asks to Grump a plan, challenge an implementation approach, find hidden assumptions, assess readiness, or produce an approve/revise/reject verdict before coding.
---
...
approvals, review-capability warnings, or clarification needed to identify the
review target.
