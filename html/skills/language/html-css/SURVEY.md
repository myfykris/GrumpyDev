...
Apply this contribution when a plan creates or changes web documents, component
markup, stylesheets, design systems, or rendered content. Skip it when HTML and
CSS does not constrain a supported build, runtime, client, data, deployment, or
operating boundary.
