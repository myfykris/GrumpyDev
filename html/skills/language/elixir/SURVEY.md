...
Apply this contribution when a plan changes Elixir or Erlang services, OTP
applications, jobs, or distributed nodes. Skip it when Elixir does not constrain
