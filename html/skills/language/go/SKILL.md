---
name: go
description: Review Go engineering plans for goroutine ownership, context propagation, interfaces, error handling, memory behavior, modules, concurrency, and service lifecycle risks. Use when a plan changes Go services, libraries, command-line tools, workers, or infrastructure code.
---
