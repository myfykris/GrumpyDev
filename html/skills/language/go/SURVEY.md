...
Apply this contribution when a plan changes Go services, libraries, command-line
tools, workers, or infrastructure code. Skip it when Go does not constrain a
