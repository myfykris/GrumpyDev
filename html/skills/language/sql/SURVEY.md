...
Apply this contribution when the project contains or executes SQL queries, reports,
stored routines, views, or database access logic independent of one storage engine.
