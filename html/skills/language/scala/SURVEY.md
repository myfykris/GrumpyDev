...
Apply this contribution when a plan changes Scala services, libraries, streaming
jobs, or JVM data systems. Skip it when Scala does not constrain a supported
