...
Apply this contribution when a system is split into independently deployed network
services. Skip it when Microservices do not constrain a supported build, runtime,
