...
Apply this contribution when events are the source of truth or reads and writes
use distinct models. Skip it when Event sourcing and CQRS does not constrain a
