...
Apply this contribution when one deployable system contains intentionally isolated
business modules. Skip it when Modular monolith does not constrain a supported build,
