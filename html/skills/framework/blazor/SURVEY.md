...
Apply this contribution when a plan changes Blazor components, routes, services,
or hosting models. Skip it when Blazor does not constrain a supported build,
