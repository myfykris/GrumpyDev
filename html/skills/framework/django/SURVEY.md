...
Apply this contribution when a Python plan changes Django applications, models,
views, middleware, tasks, or operations. Skip it when Django does not constrain
