---
name: shadcn-ui
description: Review shadcn/ui plans for source ownership, registry trust, component composition, accessibility, theming, upgrades, and local divergence. Use when a plan copies or updates shadcn/ui components or registries.
---

# shadcn/ui plan review
...
Watch especially for blindly overwriting modified components, copying examples as production
state management, trusting third-party registries as executable source, broken dialog or menu
focus after composition, and visual variants that drop semantics.
