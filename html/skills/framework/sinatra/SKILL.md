---
name: sinatra
description: Review Sinatra plans for route and middleware order, application state, request validation, concurrency, sessions, errors, and deployment risks. Use when a Ruby plan changes Sinatra applications, routes, extensions, or Rack middleware.
---
