...
Apply this contribution when a plan changes security-sensitive application
behavior or exposed attack surface. Skip it when Application security does not
