...
Apply this contribution when a plan changes build, test, release, or deployment
automation. Skip it when CI/CD does not constrain a supported build, runtime,
