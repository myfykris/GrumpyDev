...
Apply this contribution when work continues outside the request or initiating process.
Skip it when Background jobs do not constrain a supported build, runtime, client,
