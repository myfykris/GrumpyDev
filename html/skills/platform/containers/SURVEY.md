...
Apply this contribution when an application is built or run as an OCI container
image. Skip it when Container does not constrain a supported build, runtime,
