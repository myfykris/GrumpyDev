...
Apply this contribution when work or data crosses a broker, queue, stream, or pub-sub
system. Skip it when Message queues do not constrain a supported build, runtime,
