# modular-monoliths behavioral fixture
...
- How do transactions, background work, migrations, tests, and future
  extraction cross module boundaries?
...
- Domain boundary: Confirm the shared deployment
  and database boundary when it affects module ownership, migrations, failure
  isolation, or a future extraction claim.
