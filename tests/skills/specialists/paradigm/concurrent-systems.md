# concurrent-systems behavioral fixture
...
- Domain boundary: Process, thread, actor,
  coroutine, or device model; scheduler; core count; shared memory; clock;
  cancellation; resource limits; and failure isolation.
