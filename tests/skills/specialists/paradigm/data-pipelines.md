# data-pipelines behavioral fixture
...
- How are duplicates, late data, schema changes, partial reruns,
  reconciliation, and bad records handled?
...
- Domain boundary: Orchestrator, execution
  engine, batch or streaming mode, partitions, checkpoints, object or table
  storage, regions, backfill capacity, and recovery ownership.
