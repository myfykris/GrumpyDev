# event-driven-architecture behavioral fixture
...
- Domain boundary: Broker or transport, delivery
  and acknowledgement, partitions, ordering, retention, dead letters, consumer
  topology, replay, regions, and operational owner.
