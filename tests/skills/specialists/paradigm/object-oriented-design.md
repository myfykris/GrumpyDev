# object-oriented-design behavioral fixture
...
- Which substitution, identity, concurrency, persistence, or failure
  assumptions must callers respect?
...
- Domain boundary: No standing infrastructure
  question. Ask only when object identity, serialization, remote proxies,
  plugin loading, or lifecycle crosses a process or deployment boundary.
