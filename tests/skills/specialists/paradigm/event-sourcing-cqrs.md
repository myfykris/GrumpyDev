# event-sourcing-cqrs behavioral fixture
...
- Domain boundary: Event store, command and
  projection runtimes, consistency lag, replay environment, snapshot storage,
  partitioning, backup, restore, and deployment compatibility.
