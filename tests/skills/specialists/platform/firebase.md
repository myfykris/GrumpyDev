...
- Firebase projects and aliases, product regions, SDK and rules versions, indexes,
  functions runtime and concurrency, Storage rules, service accounts, secrets, emulator limits,
  quotas, billing alerts, and deployment targets.
