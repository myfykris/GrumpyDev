# grpc-protobuf behavioral fixture
...
- What deadlines, retry rules, message limits, streaming termination, and
  status details apply at each call boundary?
...
- Domain boundary: Client and server versions,
  proxies or gateways, load balancing, TLS and identity, retry policy,
  deadlines, streaming limits, generated artifact rollout, and mixed schemas.
