# data-privacy behavioral fixture
...
- Domain boundary: Processing and storage
  regions, subprocessors, tenant boundaries, backups, logs, analytics,
  retention, deletion propagation, access ownership, and disaster recovery
  copies.
