# secrets-configuration behavioral fixture
...
- Domain boundary: Secret and configuration
  sources, injection path, process scope, identity, rotation, reload,
  environment differences, redaction, fallback behavior, and owner.
