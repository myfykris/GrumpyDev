# web-accessibility behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- Which changed interactions must work by keyboard, screen reader, zoom,
...
- Domain boundary: Record supported browsers,
  webviews, assistive technologies, input modes, operating systems, rendering
  modes, and content delivery only when they affect the accessibility target.
