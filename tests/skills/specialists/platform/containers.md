...
- Domain boundary: Runtime, base image,
  architecture, user, capabilities, filesystem, mounts, network, secrets,
  resource limits, signals, health checks, image rollout, and recovery.
