# observability behavioral fixture
...
- Domain boundary: Collector and backend
  placement, network path, tenancy, regions, retention, sampling, cardinality
  limits, outage behavior, access, redaction, and incident ownership.
