# realtime-web behavioral fixture
...
- Domain boundary: WebSocket, SSE, or other
  transport; proxy and timeout behavior; connection routing; shared state;
  regions; backpressure; reconnect; scaling; and drain.
