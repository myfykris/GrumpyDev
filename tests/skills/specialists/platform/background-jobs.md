# background-jobs behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- What durable record owns each job, and what makes retry or duplicate
  execution safe?
...
- Domain boundary: Queue backend, worker
  topology, concurrency, acknowledgement and visibility, retry, dead letters,
  scheduler, shutdown, scaling, and deployment ordering.
