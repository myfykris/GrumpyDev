...
- Domain boundary: Cluster and launch type, task
  and service definitions, regions and zones, IAM roles, load balancer,
  networking, storage, secrets, scaling, rollout, drain, and recovery.
