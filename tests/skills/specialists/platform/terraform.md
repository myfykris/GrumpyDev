# terraform behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- Which Terraform or OpenTofu version, providers, backend, locking behavior,
  and execution identities apply?
...
- Domain boundary: State backend, workspaces,
  providers, execution identity, runner, environment and account boundaries,
  plan and apply separation, locking, imports, recovery, and ownership.
