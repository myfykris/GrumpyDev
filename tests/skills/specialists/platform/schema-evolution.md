# schema-evolution behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- Which readers and writers overlap, and which old data or messages can
  reappear during rollout, retry, or replay?
- What transform, backfill, validation, rollback, and repair behavior applies
  to irreversible fields?
...
- Domain boundary: Migration runner, database
  topology, application replicas, old and new version overlap, lock and
  resource limits, backfill workers, rollout order, and rollback authority.
