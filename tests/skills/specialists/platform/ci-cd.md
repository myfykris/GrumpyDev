...
- Domain boundary: Runner location and trust,
  identities, environments, artifact flow, caches, approvals, concurrency,
  secret boundaries, deployment method, rollback, and ownership.
