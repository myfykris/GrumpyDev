# testing-strategy behavioral fixture
...
- How are fixtures, time, randomness, concurrency, external systems, and
  failure injection made representative and deterministic?
...
- Domain boundary: Test environment parity,
  service substitutes, architecture and browser matrix, network and failure
  simulation, data isolation, resources, CI runners, and production-only gaps.
