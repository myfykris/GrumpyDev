# performance-capacity behavioral fixture
...
- Domain boundary: Instance and resource limits,
  replicas, autoscaling, quotas, downstream ceilings, network path, cold start,
  failure domains, load-test environment, and capacity owner.
