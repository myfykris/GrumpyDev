...
- SDK and build-tool versions, device matrix, application ID, build variants,
  permissions, exported components, network policy, storage and backup rules, signing, shrinker
  configuration, and release tracks.
