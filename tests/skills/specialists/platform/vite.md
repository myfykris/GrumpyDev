...
- Vite and plugin versions, runtime and package manager, workspace root, environment
  prefixes, browser targets, base path, client and SSR entries, output directories, assets,
  source maps, headers, and production server.
