# spring-boot behavioral fixture
...
- Domain boundary: JDK, embedded or external
  server, servlet or reactive mode, proxy, thread pools, configuration
  authority, actuator boundary, packaging, JVM limits, and shutdown.
