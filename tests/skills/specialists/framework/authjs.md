...
- framework adapter, public and internal origins, proxy headers, cookie domain and
  security, session store, provider callback URLs, secret sources, database connectivity, and
  runtime limits.
