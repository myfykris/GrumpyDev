...
- Domain boundary: Kotlin and JVM or native
  target, server engine, coroutine dispatchers, proxy, TLS, serialization,
  worker model, packaging, resource limits, and shutdown.
