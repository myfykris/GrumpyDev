...
- Domain boundary: Qt version, language binding,
  OS and window-system targets, platform plugins, native libraries,
  architecture, packaging, signing, display environment, and update channel.
