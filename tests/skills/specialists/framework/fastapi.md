...
- Domain boundary: Python, ASGI server, worker
  class and count, sync-thread pool, proxy, lifespan, sessions, background
  execution, limits, drain, and deployment.
