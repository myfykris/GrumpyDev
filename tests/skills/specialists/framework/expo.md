...
- Expo SDK and native versions, build profiles, credentials owner, application
  identifiers, update channels, runtime policy, store targets, environment sources, native
  plugins, and rollback path.
