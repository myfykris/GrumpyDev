...
- Which Ruby, Rails, database, job adapter, cache, and application-server
  versions apply?
- How do callbacks, validations, transactions, authorization, autoloading,
  jobs, and migrations interact?
...
- Domain boundary: Ruby and Rails versions,
  application server, process and thread counts, proxy, cache, sessions, Active
  Job adapter, file storage, migrations, assets, restart, and rollback.
