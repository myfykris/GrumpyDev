...
- Svelte and SvelteKit versions, adapter and host runtime, route rendering, prerender
  entries, proxy and cookie settings, environment sources, service worker, asset paths, and
  production command.
