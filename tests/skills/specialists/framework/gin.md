# gin behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- Which Go and Gin versions, server configuration, middleware order, and
  binding rules apply?
...
- Domain boundary: Go and Gin versions, proxy
  trust, worker process, limits, timeouts, file serving, signals, drain, and
