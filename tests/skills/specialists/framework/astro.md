...
- Astro output mode, adapter, host runtime, route prerendering, server and client
  islands, cache ownership, environment sources, asset handling, and production command.
