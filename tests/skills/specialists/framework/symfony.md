...
- Domain boundary: PHP SAPI and server, FPM
  pools, Messenger workers, scheduler, cache, sessions, files, proxy, compiled
  container, migrations, worker restart, and deployment.
