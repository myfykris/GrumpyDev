...
- framework and renderer, component configuration, registry sources, primitive
  versions, styling pipeline, asset sources, browser targets, CSP constraints, and build output.
