# react-native behavioral fixture
...
- React Native, React, engine and architecture versions, native toolchains, minimum OS
  levels, build variants, identifiers, permissions, signing, bundle source, updates, and
