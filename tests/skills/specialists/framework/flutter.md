...
- Domain boundary: Mobile, desktop, web, or
  embedded targets; OS versions; architectures; platform services; signing;
  packaging; updates; storage; and backend connectivity.
