...
- Domain boundary: Tokio runtime, blocking
  boundaries, worker threads, reverse proxy, TLS, body and timeout limits,
  process manager, signals, drain, and executable target.
