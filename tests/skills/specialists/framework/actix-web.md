...
- Domain boundary: Rust and Actix versions,
  worker count, async runtime, blocking pool, reverse proxy, TLS, body and
  timeout limits, process manager, drain, and shutdown.
