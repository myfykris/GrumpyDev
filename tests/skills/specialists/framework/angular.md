...
- Domain boundary: Browser targets, SSR or
  client-only mode, Node build or server runtime, base path, proxy, static
  hosting, cache, content security policy, and deployment artifact.
