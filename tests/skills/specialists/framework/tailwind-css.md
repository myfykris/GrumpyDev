# tailwind-css behavioral fixture
...
- Tailwind and plugin versions, CSS entrypoints, source roots and working directory,
  framework plugin, theme and mode settings, browser targets, asset paths, minification, and
  build command.
