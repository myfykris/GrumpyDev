# aspnet-core behavioral fixture
...
- Domain boundary: .NET and hosting model,
  Kestrel, IIS or reverse proxy, in-process or out-of-process mode, worker
  count, forwarded headers, data protection, filesystem, deployment, and drain.
