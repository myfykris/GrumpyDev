...
- Domain boundary: Server, WebAssembly, hybrid,
  and prerender modes; circuit topology; sticky sessions; client assets;
  data-protection state; proxy; and deployment differences.
