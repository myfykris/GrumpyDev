...
- Domain boundary: Elixir and OTP release, node
  topology, endpoint and proxy, PubSub adapter, clustering, sessions, Ecto
  pool, workers, rollout, and distributed shutdown.
