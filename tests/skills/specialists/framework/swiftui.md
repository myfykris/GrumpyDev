...
- Domain boundary: Apple OS range,
  architectures, app lifecycle, sandbox, entitlements, state restoration,
  helpers, signing, packaging, update, and distribution.
