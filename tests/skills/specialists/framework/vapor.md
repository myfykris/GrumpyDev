...
- Domain boundary: Swift and Vapor versions,
  event-loop and worker sizing, proxy, TLS, files, database pool, queues,
  executable platform, signals, drain, and deployment.
