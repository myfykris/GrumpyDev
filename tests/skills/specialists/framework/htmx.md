...
- server framework, template engine, htmx and extension versions, proxy cache
  variation, CSP and CSRF settings, origin behavior, static asset source, and direct-navigation
  routing.
