...
- Domain boundary: Ruby implementation, Rack and
  server, process and thread model, middleware, proxy, sessions, static files,
  timeouts, signals, and production deployment.
