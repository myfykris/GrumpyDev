...
- Domain boundary: Ruby implementation and
  version, application server, process and thread model, worker runtime, native
  extensions, OS, packaging, signals, and rolling restart behavior.
