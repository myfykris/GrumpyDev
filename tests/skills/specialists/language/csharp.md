...
- Domain boundary: .NET runtime, Windows or
  cross-platform target, architecture, framework-dependent versus
  self-contained deployment, trimming or AOT, service or desktop process model,
