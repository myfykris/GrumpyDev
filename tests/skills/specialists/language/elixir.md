...
- Which Elixir, Erlang/OTP, release target, and dependency versions define
  runtime behavior?
- Which process owns state and work, and how do supervision, messages,
  timeouts, overload, and upgrades behave?
...
- Domain boundary: Erlang/OTP and Elixir
  versions, release packaging, node topology, schedulers, clustering,
  distribution, process supervision, and rolling upgrade model.
