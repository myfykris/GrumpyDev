...
- How do quoting, word splitting, globbing, pipelines, temporary files,
  signals, errors, and encoding cross boundaries?
...
- Domain boundary: Exact shell and utilities, OS
  or container image, locale and encoding, user and privileges, non-interactive
  environment, filesystem, service manager, and scheduler.
