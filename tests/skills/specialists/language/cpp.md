...
- Domain boundary: Compiler and standard
  library, ABI, architecture, runtime linkage, allocator, plugin boundary,
  packaging, and supported operating targets.
