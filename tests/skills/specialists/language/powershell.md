...
- Domain boundary: PowerShell edition and
  version, operating system, host process, remoting method, execution identity,
  modules, policy, non-interactive service context, and serialization boundary.
