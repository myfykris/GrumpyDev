...
- Domain boundary: Browser, Node.js, edge,
  worker, embedded, or build-only execution; supported engines; event-loop
  ownership; bundling; environment injection; and deployment artifact.
