...
- How do semantics, source order, focus, responsive layout, overflow, fonts,
  and encoding behave with real content?
...
- Domain boundary: Browser and webview targets,
  base path, static serving, proxy and cache behavior, content security policy,
  asset build, localization, and offline requirements.
