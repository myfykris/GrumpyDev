...
- Domain boundary: JVM, Android, native, or
  multiplatform targets; JDK or device versions; coroutine dispatcher
  environment; packaging; and interop boundaries.
