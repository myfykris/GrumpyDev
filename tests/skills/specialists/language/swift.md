...
- Domain boundary: Apple OS versions,
  architectures, runtime availability, app or server process, concurrency
  runtime, sandbox, entitlements, signing, packaging, and distribution.
