...
- Domain boundary: Use the selected storage
  skill for topology. Add a question only when SQL is executed through a
  materially different engine, client, proxy, migration runner, or transaction
  boundary.
