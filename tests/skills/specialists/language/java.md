...
- Domain boundary: JDK vendor and version, JVM
  flags and collector, container limits, application server or standalone
  process, architecture, native libraries, packaging, and shutdown.
