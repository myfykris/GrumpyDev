# dart behavioral fixture

## Material-gap case

Review a plan in this domain whose available evidence does not answer:

- Which Dart version, target runtime, null-safety mode, package constraints,
  and isolate model apply?
...
- Domain boundary: Dart VM, AOT, Flutter,
  browser, server, isolate, architecture, packaging, and platform service
  boundaries.
