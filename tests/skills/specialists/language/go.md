...
- Domain boundary: Go version, OS and
  architecture matrix, CGO and libc, build tags, static or dynamic linkage,
  container or host process, signals, and executable packaging.
