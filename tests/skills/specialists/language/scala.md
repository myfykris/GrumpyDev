...
- How do effects, futures, cancellation, blocking, implicits, serialization,
  and Java interop cross the boundary?
...
- Domain boundary: Scala and JDK versions, JVM
  and execution context, application or cluster runtime, serializer, packaging,
  resource limits, and rolling compatibility.
