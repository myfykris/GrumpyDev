...
- Where do untyped inputs, assertions, narrowing, serialization, async work,
  and JavaScript consumers cross the boundary?
...
- Domain boundary: Runtime after compilation,
  compiler and module mode, bundler, browser or server targets, generated
  output, environment injection, source maps, and deployment artifact.
