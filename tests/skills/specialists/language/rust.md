...
- Domain boundary: Rust target triple, libc or
  static linkage, architecture, feature set, native libraries, service or
  embedded process, packaging, and FFI runtime boundary.
