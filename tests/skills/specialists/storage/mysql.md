...
- Domain boundary: Hosting model, managed
  service, nodes, primary and replicas, read routing, network and TLS,
  connection pooling, storage, failover, backup, restore, capacity, and
