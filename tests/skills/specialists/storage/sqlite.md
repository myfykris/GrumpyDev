...
- Domain boundary: Library version, process and
  connection topology, filesystem and mount, WAL behavior, write concurrency,
  packaging, backup, restore, encryption if used, and network-filesystem
  exclusions.
