# data-warehousing behavioral fixture
...
- Domain boundary: Product, compute and storage
  separation, regions, ingestion and transformation runtimes, workload
  isolation, schedules, semantic layer, backfill capacity, retention, and
  recovery.
