...
- What lock, statistics, online-operation, transaction, replication, and
  restore behavior applies to the change?
...
- Domain boundary: Product, version, edition,
  hosting, instances, databases, availability groups, isolation, storage,
  tempdb, migration, backup, restore, failover, and driver behavior.
