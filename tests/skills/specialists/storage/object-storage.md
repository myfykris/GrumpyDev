...
- Domain boundary: Provider or product, region,
  account and bucket boundary, versioning, replication, access identity,
  endpoint, encryption, lifecycle, multipart behavior, archive retrieval, and
  recovery.
