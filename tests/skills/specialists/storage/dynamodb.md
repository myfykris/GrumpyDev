...
- Domain boundary: Region and account, table and
  index design, capacity mode, partitions, global tables, consistency, streams,
  TTL, backup, restore, IAM, endpoints, and limits.
