# elasticsearch-opensearch behavioral fixture
...
- Domain boundary: Product and version, managed
  or self-hosted mode, nodes, roles, shards, replicas, zones, storage,
  snapshots, reindex capacity, security, and failover.
