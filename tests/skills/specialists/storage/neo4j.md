...
- Domain boundary: Product and version, single
  or clustered topology, roles, regions, routing, consistency, memory and
  storage, backup, restore, failover, and driver behavior.
