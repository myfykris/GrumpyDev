...
- Domain boundary: Product and version, managed
  or self-hosted mode, replica set or sharding, regions, read and write
  concerns, storage, backup, restore, failover, and driver behavior.
