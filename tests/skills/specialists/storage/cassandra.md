...
- Domain boundary: Product and version, nodes,
  data centers, replication, consistency, partitioning, repair, compaction,
  storage, capacity, backup, restore, failover, and ownership.
