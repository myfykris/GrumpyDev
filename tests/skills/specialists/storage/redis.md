...
- Domain boundary: Product and version, cache or
  authority role, topology, cluster or sentinel, memory and eviction,
  persistence, replicas, failover, TLS and identity, backup, and
  reconstruction.
